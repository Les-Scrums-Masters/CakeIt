...
export default function GamePage(props) {
  ...
  if (player === undefined || player == null || players == null) {
    ...
    return (
      <div className="mx-auto grid h-full w-full flex-col items-stretch justify-center gap-5 overflow-auto px-5 py-20 align-middle 2xl:flex 2xl:flex-row 2xl:px-20">
        <div className="grid">
          <NewsList
            socket={props.socket}
