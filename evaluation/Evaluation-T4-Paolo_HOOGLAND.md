...
- Total des points (sur 10) : 6

# Propositions d'amélioration du jeu

- Proposition 1
  ERGONOMIE: Si on cherche à vendre les gâteaux à un prix précis, on devrait pouvoir les écrire au lieu d'avoir une scrollbar
- Proposition 2
  GAMEPLAY: On devrait être capable de voir l'évolution de la concurrence pour adapter notre stratégie
...
Justifications : Le Git est bien fait, une explication figure sur la page et explique comment faire le téléchargement; les commits sont bien faits et il y a + de 300 commits. Le CDC est aussi conforme au document partagé de travail.
...
Justifications : L'installation du prototype était facile, rapide, marche parfaitement et le tutoriel permet de tout comprendre les fonctionnalités du jeu. On comprend comment marche le marché du cake de chocolat parfaitement, et les actions qu'on pourra réaliser au long du jeu.
...
Justifications : Le cahier de charges est très bien expliqué, et permet de comprendre l'application avant de l'utiliser. Le diagramme de classes permet de mieux comprendre le fonctionnement.
...
Justifications : Toutes les fonctionnalités sont précises et installées à chaque tour du jeu; la description permet la compréhension complète du jeu et permet un gameplay très facile. Les fonctionnalités ne comptent pas avec un niveau de difficulté vu qu'on parle d'un jeu à tours(où chaque personne jour un tour par round); la vraie difficulté est trouver une stratégie pour gagner contre les concurrents.
...
Justifications : Tous les scénarios présentent les fonctionnalités augmenter/baisser le prix/quantité. Chaque nouveau tour présente un nouveau scénario, avec des prix qui évoluent et qui nous font chercher une nouvelle stratégie.
