...
1. Rajouter une zone de texte où l'on peut rentrer une valeur en plus des scrollbars (prix / quantité), permettrai de mieux contrôler sa partie
2. Il y a beaucoup d'informations à l'écran, ranger les graphs et/ou les news dans une/des fenêtre(s) pop-up permettrai d'alléger l'écran
3. Sur le graph, rajouter un indicateur qui suivrai le curseur permettrai de lire plus simplement les variations de prix des différents ingrédients
...
Les commits sont renseignés et pertinents pour les membres de l'équipe mais par pour un oeuil exterieur.
...
Le jeu web s'est lancé parfaitement, en cliquant sur un bouton.
...
Le CDC est exhaustif et parfaitement clair. Le jeu suit à la lettre ce qui y est écrit.
...
Les scenarios principaux et secondaires sont bien developpés et se basent ou decoulent de toutes les fonctionnalités du jeu.
